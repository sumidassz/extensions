...
local function loadAFS()
	...
	local function autoDefenseFunc(worldSelected, worldSave, friendsOnly)
        ...
        elseif game.Players.LocalPlayer.World.Value == "Summer2" then
            ...
            elseif passiveImage == "rbxassetid://7375247842" then return "Summer Rich"
            elseif passiveImage == "rbxassetid://7375248119" then return "Summer Genius"
            elseif passiveImage == "rbxassetid://7375577988" then return "Summer Tactical"
            elseif passiveImage == "rbxassetid://7375578212" then return "Summer Collector"
            elseif passiveImage == "rbxassetid://8062985782" then return "Summer Sorcerer"
            elseif passiveImage == "rbxassetid://8608070794" then return "Summer Lucky"
            elseif passiveImage == "rbxassetid://8172421057" then return "Summer Leader"
            elseif passiveImage == "rbxassetid://10497570620" then return "Flaming"
            elseif passiveImage == "rbxassetid://10497570394" then return "Relaxed"
            elseif passiveImage == "rbxassetid://10497668451" then return "General"
            elseif passiveImage == "rbxassetid://7375247348" and passiveColor ~= "21, 173, 255" then return "Crew Leader" end
        end
    end
		...
		for i, v in pairs(game.Players.LocalPlayer.PlayerGui.MainGui.Pets.Main.Scroll:GetChildren()) do
			if v:IsA("ImageButton") and v:FindFirstChild("UID") and v:FindFirstChild("PetName") and v:FindFirstChild("Passives") then
				if tostring(fighterUID) == tostring(v.UID.Value) and slot == "Slot 2" and v.Passives:FindFirstChild("2") then
					...
					elseif passiveChoosed ~= nil and table.find(passiveArray, passiveChoosed) and webhook == true and webhookURL ~= 'None' and webhookUserId ~= 'None' and gotIt == false then
						gotIt = true
	...
	for i, v in pairs(whatGot) do
		sendWebhookForPassive(v, v, Options.webhookURL.Value, Options.webhookUserId.Value)
		whatGot = {}
	end
	end
	...
	local function autoEggFunc() if getEgg(game.Players.LocalPlayer.World.Value) ~= nil then game.ReplicatedStorage.Remote.OpenEgg:InvokeServer(workspace.Worlds:FindFirstChild(tostring(game.Players.LocalPlayer.World.Value))[getEgg(game.Players.LocalPlayer.World.Value)], tonumber(getManyEggs())) rtvytrvyrt() end end
	local function autoMaxOpenFunc() game.ReplicatedStorage.Remote.AttemptMultiOpen:FireServer(getEgg(game.Players.LocalPlayer.World.Value)) rtvytrvyrt() end
